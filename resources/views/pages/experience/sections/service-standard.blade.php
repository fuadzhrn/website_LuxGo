@php
    /* Three pillars, fixed by the layout — the CMS supplies their wording. */
    $servicePillars = [
        ['number' => '01', 'title' => $s->text('pillars.professional.title'), 'copy' => $s->text('pillars.professional.copy')],
        ['number' => '02', 'title' => $s->text('pillars.hospitality.title'), 'copy' => $s->text('pillars.hospitality.copy')],
        ['number' => '03', 'title' => $s->text('pillars.privacy.title'), 'copy' => $s->text('pillars.privacy.copy')],
    ];
@endphp
    ...
    <div class="lux-container">
        <div class="experience-standard__header" data-reveal>
            <div class="experience-standard__heading">
                <p class="experience-standard__eyebrow">{{ $s->text('eyebrow') }}</p>

                <h2 class="experience-standard__title">
                    <span class="experience-standard__title-line">{{ $s->text('title_1') }}</span>
                    <span class="experience-standard__title-line">{{ $s->text('title_2') }}</span>
                </h2>
            </div>
        </div>
        ...
        <div class="lux-container experience-standard__cta-inner" data-reveal>
            <div class="experience-standard__cta-content">
                <h2 class="experience-standard__cta-title">
                    <span class="experience-standard__title-line">{{ $s->text('cta_title_1') }}</span>
                    <span class="experience-standard__title-line">{{ $s->text('cta_title_2') }}</span>
                </h2>
            ...
            <a href="{{ $s->link('cta_target') }}" class="experience-standard__link">
